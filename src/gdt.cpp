...
GlobalDescriptorTable::GlobalDescriptorTable()
    : null_ss(0, 0, 0),
      ...
      process_ss(0, 16*1024*1024, 0x96)
{
}
...
uint16_t GlobalDescriptorTable::get_dss()
{
    return (uint8_t*)&data_ss - (uint8_t*)this;
}

uint16_t GlobalDescriptorTable::get_css()
{
    return (uint8_t*)&code_ss - (uint8_t*)this;
}
...
uint16_t GlobalDescriptorTable::get_pss() {
    return (uint8_t*)&process_ss - (uint8_t*)this;
}
...
uint32_t GlobalDescriptorTable::SegmentDescriptor::get_base()
{
    uint8_t* target = (uint8_t*)this;
